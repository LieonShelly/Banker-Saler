...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    NSDictionary *dic = @{@"date":self.date };
    
    [[NSNotificationCenter defaultCenter]postNotificationName:@"notifacationDate" object:self userInfo:dic];
}
