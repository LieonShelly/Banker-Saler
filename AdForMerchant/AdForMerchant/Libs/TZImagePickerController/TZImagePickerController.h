...
/*
 ...
 最初发现这个问题并修复的是@小鱼周凌宇同学，她的博客地址: https://zhoulingyu.com/
 表示感谢~
...
@property (nonatomic, copy) NSString *photoOriginImageName;
@property (nonatomic, copy) NSString *photoOriginImageSelName;
