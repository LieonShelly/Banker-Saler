...
- (void)configDefaultImageName {
    ...
    self.photoSelImageName = @"photo_check_selected";
    ...
    self.photoOriginImageSelName = @"compose_photo_original_highlighted";
    self.photoOriginImageName = @"compose_photo_original";
    self.arrowUp = @"navigationbar_arrow_up";
    self.arrowDown = @"navigationbar_arrow_down";
}
...
- (UIButton *)titleButton {
    if(!_titleButton){
        ...
        [_titleButton setTitle:@"相片" forState:0];
