...
//        [_originalPhotoButton setImage:[UIImage imageNamedFromMyBundle:_tzImagePickerVc.photoOriginImageName] forState:UIControlStateNormal];
//        [_originalPhotoButton setImage:[UIImage imageNamedFromMyBundle:_tzImagePickerVc.photoOriginImageSelName] forState:UIControlStateSelected];
