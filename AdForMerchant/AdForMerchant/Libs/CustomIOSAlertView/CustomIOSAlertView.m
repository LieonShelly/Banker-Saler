...
- (id)init
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(becomeFirstResponderWhenBecomeActive) name:UIApplicationDidBecomeActiveNotification object:nil];
...
// Fix issue where container view stay at the center when app become active from background

- (void)becomeFirstResponderWhenBecomeActive {
