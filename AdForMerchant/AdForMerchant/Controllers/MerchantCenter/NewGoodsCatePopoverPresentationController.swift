//
//  NewGoodsCatePopoverPresentationController.swift
//  AdForMerchant
//
...
class NewGoodsCatePopoverPresentationController: UIPresentationController {
...
class TransitionAnimator: NSObject, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
    ...
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        let pc = NewGoodsCatePopoverPresentationController(presentedViewController: presented, presenting: presenting)
